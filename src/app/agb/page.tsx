...
const terms = [
  {
    ...
    text: "Leistungen werden nach individueller Anfrage, technischer Einschätzung und Terminabstimmung erbracht."
  },
  {
    title: "Reparaturentscheidung",
    text: "Vor-Ort-Reparaturen hängen von Fehlerbild, Ersatzteilverfügbarkeit, Sicherheitszustand und Wirtschaftlichkeit ab."
  },
  {
    title: "Preise & Termine",
    text: "Preis- und Terminangaben werden individuell abgestimmt und können je nach Gerät, Standort und Aufwand variieren."
  },
  {
    title: "Geschäftskunden",
    text: "Für Geschäftskunden, Hausverwaltungen und Objektbetreuung können gesonderte Vereinbarungen gelten."
  }
];
          ...
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-end lg:gap-20">
            <div className="reveal">
              ...
              <p className="mt-8 max-w-2xl text-[1.05rem] font-light leading-relaxed text-[color:var(--muted)]">
                Grundsätzliche Bedingungen für Reparaturleistungen und Serviceanfragen von
                {` ${serviceName}`}.
              </p>
            </div>
            ...
            <div className="reveal border-l border-[color:var(--border)] py-2 pl-8">
              ...
              <p className="mt-5 text-sm font-light leading-relaxed text-[color:var(--muted)]">
                Für konkrete Preis- und Terminfragen bitte direkt telefonisch Kontakt aufnehmen.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white py-20 sm:py-24 lg:py-28">
        <div className="mx-auto max-w-[88rem] px-5 sm:px-8">
          <div className="grid gap-px bg-[color:var(--border)] lg:grid-cols-3">
            ...
            <article className="bg-white p-8 lg:p-10">
              <p className="cap-line tracking-eyebrow text-[color:var(--accent)]">Geltung</p>
              ...
              <p className="mt-5 font-light leading-relaxed text-[color:var(--muted)]">
                Reparaturen, Termine und Preise werden abhängig von Gerät, Fehlerbild und
                Standort abgestimmt.
              </p>
            </article>
          ...
          <div className="stagger mt-16 grid gap-px bg-[color:var(--border)] md:grid-cols-2">
            {terms.map((term, index) => (
              <section key={term.title} className="bg-[color:var(--bg-muted)] p-8 lg:p-10">
